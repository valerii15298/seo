...
cd $rootdir && git clone https://github.com/valerii15298/seo.git app && mkdir -p app/semrush-keywords app/screaming-frog && cd app && npm init -y && npm i node-fetch express puppeteer googleapis && npm install -g pm2
